...
{
       0,    76,    76,    76,    78,    81,    82,    85,    87,    89,
      90,    94,    95,    99,   100,   102,   104,   108,   113,   115,
     117,   119,   123,   125,   128,   130,   133,   134,   136,   138,
     140,   142,   144,   146,   148,   150,   152,   154,   156,   158,
     160,   164,   165,   166,   168,   171,   173
};
#endif
...
#line 77 "trad2.y"
                                             { ; }
#line 1271 "trad2.tab.c"
    break;

  case 4: /* axiom: MAIN '(' ')' '{' code '}'  */
#line 78 "trad2.y"
                                             { printf("(defun main () %s)\n", yyvsp[-1].code) ; }
#line 1277 "trad2.tab.c"
    break;

  case 5: /* r_axiom: %empty  */
#line 81 "trad2.y"
                                             { ; }
#line 1283 "trad2.tab.c"
    break;

  case 6: /* r_axiom: axiom  */
#line 82 "trad2.y"
                                             { ; }
#line 1289 "trad2.tab.c"
    break;
...
#line 95 "trad2.y"
                                             { sprintf (temp, "(setq %s %s)", yyvsp[-2].code, yyvsp[0].code) ;
                                               yyval.code = gen_code(temp) ; }
#line 1328 "trad2.tab.c"
    break;

  case 13: /* sentence: INTEGER rec_def  */
#line 99 "trad2.y"
                                             { yyval = yyvsp[0] ; }
#line 1334 "trad2.tab.c"
    break;
