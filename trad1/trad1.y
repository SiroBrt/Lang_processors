...
code:         sentence ';' code              { sprintf (temp, "%s %s", $1.code, $3.code) ;
                                               $$.code = gen_code(temp) ; }
            | sentence ';'                   { $$.code = $1.code ; }


sentence:     INTEGER recursion_def          { $$.code = $2.code ; }
...
recursion_def:definition ',' recursion_def   { sprintf (temp, "%s %s",$1.code, $3.code);
                                               $$.code = gen_code (temp) ; }
            | definition                     { $$.code = $1.code ; }
            ;
