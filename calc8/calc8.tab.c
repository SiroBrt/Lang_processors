...
{
       0,   159,   159,   159,   162,   162,   168,   169,   172,   174,
...
static const char *const yytname[] =
{
  ...
  "'='", "'+'", "'-'", "'*'", "'/'", "UNARY_SIGN", "'\\n'", "'@'", "'('",
  "')'", "$accept", "axiom", "$@1", "$@2", "r_expr", "expression", "term",
  "operand", YY_NULLPTR
};
...
static const yytype_int8 yydefact[] =
{
      ...
      14,     0,    17,    15,    16,     0,     0,     1,     0,     0,
       0,     0,     2,     9,     4,    19,    10,    11,    12,    13,
       6,     6,     7,     3,     5
};
...
#line 1277 "calc8.tab.c"
  ...
  case 9: /* expression: VARIABLE '=' expression  */
#line 174 "calc8.y"
                                                          { yyval.node = createASTNode("setq", 2, createASTNode (char_to_string (yyvsp[-2].index+'a'), 0, NULL, NULL), yyvsp[0].node); }
#line 1283 "calc8.tab.c"
    break;

  case 10: /* expression: expression '+' expression  */
#line 175 "calc8.y"
                                                        { yyval.node = createASTNode ("+", 2, yyvsp[-2].node, yyvsp[0].node); }
#line 1289 "calc8.tab.c"
    break;

  case 11: /* expression: expression '-' expression  */
#line 176 "calc8.y"
                                                        { yyval.node = createASTNode ("-", 2, yyvsp[-2].node, yyvsp[0].node); }
#line 1295 "calc8.tab.c"
    break;

  case 12: /* expression: expression '*' expression  */
#line 177 "calc8.y"
                                                        { yyval.node = createASTNode ("*", 2, yyvsp[-2].node, yyvsp[0].node); }
#line 1301 "calc8.tab.c"
    break;

  case 13: /* expression: expression '/' expression  */
#line 178 "calc8.y"
                                                        { yyval.node = createASTNode ("/", 2, yyvsp[-2].node, yyvsp[0].node); }
#line 1307 "calc8.tab.c"
    break;

  case 14: /* term: operand  */
#line 181 "calc8.y"
                                                        { yyval.node = yyvsp[0].node; }
#line 1313 "calc8.tab.c"
    break;

  case 15: /* term: '+' operand  */
#line 182 "calc8.y"
                                                        { yyval.node = yyvsp[0].node; }
#line 1319 "calc8.tab.c"
    break;

  case 16: /* term: '-' operand  */
#line 183 "calc8.y"
                                                        { yyval.node = createASTNode ("-", 1, yyvsp[0].node, NULL); }
#line 1325 "calc8.tab.c"
    break;

  case 17: /* operand: VARIABLE  */
#line 186 "calc8.y"
                                                        { yyval.node = createASTNode (char_to_string (yyvsp[0].index+'a'), 0, NULL, NULL); }
#line 1331 "calc8.tab.c"
    break;

  case 18: /* operand: NUMBER  */
#line 187 "calc8.y"
                                                        { yyval.node = createASTNode (int_to_string (yyvsp[0].value), 0, NULL, NULL); }
#line 1337 "calc8.tab.c"
    break;

  case 19: /* operand: '(' expression ')'  */
#line 188 "calc8.y"
                                                        { yyval.node = yyvsp[-1].node; }
#line 1343 "calc8.tab.c"
    break;
